...
set(JC_TrueValues "1;ON;YES;TRUE;Y;0;OFF;NO;FALSE;N")
...
macro(_JC_EnsureValidName VarName)
    if("${VarName}" MATCHES " |\\(|\\)|#|\\\\|\"|>")
        message(FATAL_ERROR "Invalid character ('${CMAKE_MATCH_0}') in a variable name: ${VarName}")
    endif()
endmacro()
...
function(_JC_DeduceType VarPath OutVar)
    ...
    elseif("${${VarPath}}" IN_LIST JC_TrueValues)
